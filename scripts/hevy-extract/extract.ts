...
function extractSpec(jsSource: string): Record<string, unknown> {
  ...
  const SwaggerUIBundle = Object.assign(
    (opts: Record<string, unknown>) => {
      ...
      return { initOAuth() {}, preauthorizeApiKey: () => true, authActions: { authorize() {} } };
    },
  ...
  new Function("window", "SwaggerUIBundle", "SwaggerUIStandalonePreset", "setInterval", jsSource)(
...
const extract = defineCommand({
  ...
  options: {
    url: option(z.url().default("https://api.hevyapp.com/docs/swagger-ui-init.js"), {
