...
class WorkoutsApi:
    ...
    async def get_workout_count(
        ...
        _param = self._get_workout_count_serialize(
            api_key=api_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def get_workout_count_with_http_info(
        ...
        _headers: dict[StrictStr, Any] | None = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetWorkoutCount200Response]:
        """Get the total number of workouts on the account
    ...
    def _get_workout_count_serialize(
        self,
        api_key,
        _request_auth,
        _content_type,
    ...
    async def get_workout_events(
        ...
        _param = self._get_workout_events_serialize(
            api_key=api_key,
            page=page,
            page_size=page_size,
            since=since,
    ...
    def _get_workout_events_serialize(
        self,
        api_key,
        page,
        page_size,
