...
------------- | ------------- | -------------
[**create_custom_exercise_template**](ExerciseTemplatesApi.md#create_custom_exercise_template) | **POST** /v1/exercise_templates | Create a new custom exercise template.
[**get_exercise_template_by_id**](ExerciseTemplatesApi.md#get_exercise_template_by_id) | **GET** /v1/exercise_templates/{exerciseTemplateId} | Get a single exercise template by id.
...
> CreateCustomExerciseTemplate200Response create_custom_exercise_template(api_key, create_custom_exercise_request_body)
...
async with hevy_api_service.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ExerciseTemplatesApi->create_custom_exercise_template: %s\n" % e)
```
...
[**CreateCustomExerciseTemplate200Response**](CreateCustomExerciseTemplate200Response.md)
...
# **get_exercise_template_by_id**
> ExerciseTemplate get_exercise_template_by_id(api_key, exercise_template_id)
...
async with hevy_api_service.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ExerciseTemplatesApi->get_exercise_template_by_id: %s\n" % e)
```
