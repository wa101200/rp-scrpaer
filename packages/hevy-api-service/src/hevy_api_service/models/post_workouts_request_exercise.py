...
class PostWorkoutsRequestExercise(BaseModel):
    ...
    sets: conlist(PostWorkoutsRequestSet) | None = None
    __properties = ["exercise_template_id", "superset_id", "notes", "sets"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostWorkoutsRequestExercise:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostWorkoutsRequestExercise:
        """Create an instance of PostWorkoutsRequestExercise from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostWorkoutsRequestExercise.parse_obj(obj)

        _obj = PostWorkoutsRequestExercise.parse_obj(
            {
                "exercise_template_id": obj.get("exercise_template_id"),
                "superset_id": obj.get("superset_id"),
                "notes": obj.get("notes"),
                "sets": [
                    PostWorkoutsRequestSet.from_dict(_item) for _item in obj.get("sets")
                ]
