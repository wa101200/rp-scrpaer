...
class WorkoutExercisesInnerSetsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkoutExercisesInnerSetsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkoutExercisesInnerSetsInner:
        """Create an instance of WorkoutExercisesInnerSetsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkoutExercisesInnerSetsInner.parse_obj(obj)

        _obj = WorkoutExercisesInnerSetsInner.parse_obj(
            {
                "index": obj.get("index"),
                "type": obj.get("type"),
