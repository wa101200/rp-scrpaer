...
class PutRoutinesRequestSet(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PutRoutinesRequestSet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PutRoutinesRequestSet:
        """Create an instance of PutRoutinesRequestSet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PutRoutinesRequestSet.parse_obj(obj)

        _obj = PutRoutinesRequestSet.parse_obj(
            {
                "type": obj.get("type"),
