...
class ExerciseHistoryEntry(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExerciseHistoryEntry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExerciseHistoryEntry:
        """Create an instance of ExerciseHistoryEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExerciseHistoryEntry.parse_obj(obj)

        _obj = ExerciseHistoryEntry.parse_obj(
            {
