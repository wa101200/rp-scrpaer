...
class CreateCustomExerciseTemplate403Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCustomExerciseTemplate403Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCustomExerciseTemplate403Response:
        """Create an instance of CreateCustomExerciseTemplate403Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCustomExerciseTemplate403Response.parse_obj(obj)

        _obj = CreateCustomExerciseTemplate403Response.parse_obj(
            {"error": obj.get("error")}
        )
        return _obj
