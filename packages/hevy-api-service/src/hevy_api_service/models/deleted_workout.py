...
class DeletedWorkout(BaseModel):
    ...
    type: StrictStr = Field(
        default=..., description="Indicates the type of the event (deleted)"
    )
    id: StrictStr = Field(
        default=..., description="The unique identifier of the deleted workout"
    )
    deleted_at: StrictStr | None = Field(
        default=None,
        description="A date string indicating when the workout was deleted",
    )
    __properties = ["type", "id", "deleted_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeletedWorkout:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeletedWorkout:
        """Create an instance of DeletedWorkout from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeletedWorkout.parse_obj(obj)

        _obj = DeletedWorkout.parse_obj(
            {
                "type": obj.get("type"),
                "id": obj.get("id"),
