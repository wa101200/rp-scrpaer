...
class CreateCustomExerciseTemplate400Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCustomExerciseTemplate400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCustomExerciseTemplate400Response:
        """Create an instance of CreateCustomExerciseTemplate400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCustomExerciseTemplate400Response.parse_obj(obj)

        _obj = CreateCustomExerciseTemplate400Response.parse_obj(
            {"error": obj.get("error")}
        )
        return _obj
