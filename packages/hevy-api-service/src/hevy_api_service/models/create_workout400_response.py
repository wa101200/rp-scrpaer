...
class CreateWorkout400Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateWorkout400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateWorkout400Response:
        """Create an instance of CreateWorkout400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateWorkout400Response.parse_obj(obj)

        _obj = CreateWorkout400Response.parse_obj({"error": obj.get("error")})
        return _obj
