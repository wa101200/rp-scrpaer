...
class PostWorkoutsRequestBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostWorkoutsRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostWorkoutsRequestBody:
        """Create an instance of PostWorkoutsRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostWorkoutsRequestBody.parse_obj(obj)

        _obj = PostWorkoutsRequestBody.parse_obj(
            {
                "workout": PostWorkoutsRequestBodyWorkout.from_dict(obj.get("workout"))
