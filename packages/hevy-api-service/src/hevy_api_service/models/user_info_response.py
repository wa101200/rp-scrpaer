...
class UserInfoResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserInfoResponse:
        """Create an instance of UserInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserInfoResponse.parse_obj(obj)

        _obj = UserInfoResponse.parse_obj(
            {
                "data": UserInfo.from_dict(obj.get("data"))
