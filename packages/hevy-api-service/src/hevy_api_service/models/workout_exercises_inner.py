...
class WorkoutExercisesInner(BaseModel):
    ...
    sets: conlist(WorkoutExercisesInnerSetsInner) | None = None
    __properties = [
        "index",
        "title",
        "notes",
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkoutExercisesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkoutExercisesInner:
        """Create an instance of WorkoutExercisesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkoutExercisesInner.parse_obj(obj)

        _obj = WorkoutExercisesInner.parse_obj(
            {
                "index": obj.get("index"),
                "title": obj.get("title"),
                "notes": obj.get("notes"),
