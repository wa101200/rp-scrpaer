...
class PostWorkoutsRequestBodyWorkout(BaseModel):
    ...
    exercises: conlist(PostWorkoutsRequestExercise) | None = None
    __properties = [
        "title",
        "description",
        "start_time",
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostWorkoutsRequestBodyWorkout:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostWorkoutsRequestBodyWorkout:
        """Create an instance of PostWorkoutsRequestBodyWorkout from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostWorkoutsRequestBodyWorkout.parse_obj(obj)

        _obj = PostWorkoutsRequestBodyWorkout.parse_obj(
            {
                "title": obj.get("title"),
