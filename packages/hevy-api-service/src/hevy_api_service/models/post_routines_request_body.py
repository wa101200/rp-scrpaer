...
class PostRoutinesRequestBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostRoutinesRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostRoutinesRequestBody:
        """Create an instance of PostRoutinesRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostRoutinesRequestBody.parse_obj(obj)

        _obj = PostRoutinesRequestBody.parse_obj(
            {
                "routine": PostRoutinesRequestBodyRoutine.from_dict(obj.get("routine"))
