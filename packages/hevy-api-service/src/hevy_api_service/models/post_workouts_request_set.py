...
class PostWorkoutsRequestSet(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostWorkoutsRequestSet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostWorkoutsRequestSet:
        """Create an instance of PostWorkoutsRequestSet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostWorkoutsRequestSet.parse_obj(obj)

        _obj = PostWorkoutsRequestSet.parse_obj(
            {
                "type": obj.get("type"),
