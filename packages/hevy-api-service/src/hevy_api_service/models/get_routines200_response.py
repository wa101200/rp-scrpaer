...
class GetRoutines200Response(BaseModel):
    ...
    routines: conlist(Routine) | None = None
    __properties = ["page", "page_count", "routines"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRoutines200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRoutines200Response:
        """Create an instance of GetRoutines200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRoutines200Response.parse_obj(obj)

        _obj = GetRoutines200Response.parse_obj(
            {
                "page": obj.get("page"),
                "page_count": obj.get("page_count"),
                "routines": [Routine.from_dict(_item) for _item in obj.get("routines")]
