...
class ExerciseTemplatesApi:
    ...
    def create_custom_exercise_template(
        ...
        _param = self._create_custom_exercise_template_serialize(
            api_key=api_key,
    ...
    def create_custom_exercise_template_with_http_info(
        ...
        _headers: dict[StrictStr, Any] | None = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateCustomExerciseTemplate200Response]:
        """Create a new custom exercise template.
    ...
    def _create_custom_exercise_template_serialize(
        self,
        api_key,
    ...
    def get_exercise_template_by_id(
        ...
        _param = self._get_exercise_template_by_id_serialize(
            api_key=api_key,
    ...
    def _get_exercise_template_by_id_serialize(
        self,
        api_key,
