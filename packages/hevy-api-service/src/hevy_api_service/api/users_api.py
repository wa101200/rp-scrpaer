...
class UsersApi:
    ...
    @validate_arguments
    def get_user_info(self, api_key: StrictStr, **kwargs) -> UserInfoResponse:  # noqa: E501
        """Get user info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_user_info(api_key, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_user_info_with_http_info(api_key, **kwargs)  # noqa: E501

    @validate_arguments
    def get_user_info_with_http_info(self, api_key: StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """Get user info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_user_info_with_http_info(api_key, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(UserInfoResponse, status_code(int), headers(HTTPHeaderDict))
        """
