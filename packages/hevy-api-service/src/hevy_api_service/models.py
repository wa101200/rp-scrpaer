...
#   timestamp: 2026-02-28T19:38:44+00:00
...
class PostWorkoutsRequestSet(BaseModel):
    type: Type | None = Field(
        None, description="The type of the set.", examples=["normal"]
    )
    weight_kg: float | None = Field(
        None, description="The weight in kilograms.", examples=[100]
    )
    reps: int | None = Field(
        None, description="The number of repetitions.", examples=[10]
    )
    distance_meters: int | None = Field(
        None, description="The distance in meters.", examples=[None]
    )
    duration_seconds: int | None = Field(
        None, description="The duration in seconds.", examples=[None]
    )
    ...
    rpe: Rpe | None = Field(
        None, description="The Rating of Perceived Exertion (RPE).", examples=[None]
    )


class PostWorkoutsRequestExercise(BaseModel):
    exercise_template_id: str | None = Field(
        None, description="The ID of the exercise template.", examples=["D04AC939"]
    )
    superset_id: int | None = Field(
        None, description="The ID of the superset.", examples=[None]
    )
    notes: str | None = Field(
        None,
        description="Additional notes for the exercise.",
        examples=["Felt good today. Form was on point."],
    )
...
class Workout(BaseModel):
    title: str | None = Field(
        None, description="The title of the workout.", examples=["Friday Leg Day 🔥"]
    )
    description: str | None = Field(
        None,
        description="A description for the workout workout.",
        examples=["Medium intensity leg day focusing on quads."],
    )
    start_time: str | None = Field(
        None,
        description="The time the workout started.",
        examples=["2024-08-14T12:00:00Z"],
    )
    end_time: str | None = Field(
        None,
        description="The time the workout ended.",
        examples=["2024-08-14T12:30:00Z"],
    )
...
class RepRange(BaseModel):
    start: float | None = Field(
        None, description="Starting rep count for the range", examples=[8]
    )
    end: float | None = Field(
        None, description="Ending rep count for the range", examples=[12]
    )
...
class PostRoutinesRequestExercise(BaseModel):
    ...
    rest_seconds: int | None = Field(
        None, description="The rest time in seconds.", examples=[90]
    )
    notes: str | None = Field(
        None,
        description="Additional notes for the exercise.",
        examples=["Stay slow and controlled."],
    )
...
class Routine(BaseModel):
    title: str | None = Field(
        None, description="The title of the routine.", examples=["April Leg Day 🔥"]
    )
...
class Set(BaseModel):
    ...
    weight_kg: float | None = Field(
        None, description="Weight lifted in kilograms.", examples=[100]
    )
    reps: float | None = Field(
        None, description="Number of reps logged for the set", examples=[10]
    )
...
class Exercise(BaseModel):
    ...
    title: str | None = Field(
        None, description="Title of the exercise", examples=["Bench Press (Barbell)"]
    )
    notes: str | None = Field(
        None,
...
class ExerciseHistoryEntry(BaseModel):
    workout_id: str | None = Field(
        ...
        examples=["b459cba5-cd6d-463c-abd6-54f8eafcadcb"],
    )
    workout_title: str | None = Field(
        None, description="The workout title", examples=["Morning Workout 💪"]
    )
    ...
    workout_end_time: str | None = Field(
        ...
        examples=["2024-01-01T13:00:00Z"],
    )
    exercise_template_id: str | None = Field(
        None, description="The exercise template ID", examples=["D04AC939"]
    )
    weight_kg: float | None = Field(
        None, description="The weight in kilograms", examples=[100]
    )
    ...
    rpe: float | None = Field(
        None, description="The Rating of Perceived Exertion", examples=[8.5]
    )
    custom_metric: float | None = Field(
        None, description="A custom metric for the set", examples=[None]
    )
...
class ExerciseTemplate(BaseModel):
    ...
    title: str | None = Field(
        None, description="The exercise title.", examples=["Bench Press (Barbell)"]
    )
    type: str | None = Field(
        None, description="The exercise type.", examples=["weight_reps"]
    )
...
class RoutineFolder1(BaseModel):
    id: float | None = Field(None, description="The routine folder ID.", examples=[42])
    index: float | None = Field(
        None,
    ...
    title: str | None = Field(
        None, description="The routine folder title.", examples=["Push Pull 🏋️\u200d♂️"]
    )
    updated_at: str | None = Field(
        None,
        description="ISO 8601 timestamp of when the folder was last updated.",
        examples=["2021-09-14T12:00:00Z"],
    )
...
class Exercise2(BaseModel):
    ...
    notes: str | None = Field(
        ...
        examples=["Focus on form. Go down to 90 degrees."],
    )
    exercise_template_id: str | None = Field(
        None,
        description="The id of the exercise template. This can be used to fetch the exercise template.",
...
class Routine2(BaseModel):
    ...
    title: str | None = Field(
        None, description="The routine title.", examples=["Upper Body 💪"]
    )
    folder_id: float | None = Field(
        None, description="The routine folder ID.", examples=[42]
    )
    updated_at: str | None = Field(
        None,
...
class UserInfo(BaseModel):
    id: str | None = Field(
        ...
        examples=["9c465af3-de7d-42bc-9c7c-f0170396358b"],
    )
    name: str | None = Field(
        None, description="The user's display name.", examples=["John doe"]
    )
    url: str | None = Field(
        None,
        description="The user's public profile URL.",
        examples=["https://hevy.com/user/jhon"],
    )
...
class Workout1(BaseModel):
    ...
    description: str | None = Field(
        ...
        examples=["Pushed myself to the limit today!"],
    )
    start_time: str | None = Field(
        None,
        description="ISO 8601 timestamp of when the workout was recorded to have started.",
...
class PaginatedWorkoutEvents(BaseModel):
    ...
    page_count: int = Field(
        ..., description="The total number of pages available", examples=[5]
    )
